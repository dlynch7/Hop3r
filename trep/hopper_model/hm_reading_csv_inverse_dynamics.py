...
csvPath = '/Users/gregniederschulte/Documents/GitHub/Hop3r/trep/hopper_model/JointVelocities3.csv'
...
# (theta2, theta3, theta5, theta7)
system.q = (2.0944, -1.0472, -2.3778, 2.3778)
# (theta1, theta4, theta6)
system.qk = (-2.618+math.pi/2, -1.489+math.pi/2, -1.6526+(math.pi/2))
